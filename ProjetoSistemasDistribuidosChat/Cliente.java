...
class SenderThread extends Thread {
    ...
    public void run() {
        //Variável que receberá o nick do usuário
        String nomeUsuario;
        ...
        try {
            ...
            while (true) {
                ...
                if (clientMessage.equals(quit)) {
                    ...
                    System.out.println("Mensagem excedeu o limite de 140 caracteres");
                } else {
    ...
    //Método que cria a mensagem, concatenando a hora, o nick e a mensagem
    ...
    //Pega a hora atual e a converte
    public static String horaAtual() {
        return new SimpleDateFormat("HH:mm:ss").format(new Date());
    }
}

//Thread usada para receber
